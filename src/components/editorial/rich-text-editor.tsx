    ...
    <div className="rich-text-editor-shell">
      <Editor
        ...
        init={{
          ...
          valid_elements: 'p,h2,h3,h4,ul,ol,li,a[href|target|rel],strong,em,u,s,sub,sup,img[src|alt],table,thead,tbody,tr,th,td,pre,code,blockquote,hr,video[src|controls],span',
